h1. TODO.TXT Command Line Interface - Forked with my configs !https://secure.travis-ci.org/ginatrapani/todo.txt-cli.png?branch=master(Build Status)!:http://travis-ci.org/ginatrapani/todo.txt-cli
...
* Add "danny" remote to git config 
  [remote "danny"]
  url = git@github.com:Dannyzen/todo.txt-cli.git
  fetch = +refs/heads/*:refs/remotes/danny/*
* $TODO env is private
